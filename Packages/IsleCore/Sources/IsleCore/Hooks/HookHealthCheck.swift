...
public struct HookHealthReport: Equatable, Sendable {
    ...
    public enum Issue: Equatable, Sendable, CustomStringConvertible {
        ...
        /// Other hooks detected alongside Isle hooks (informational).
...
public enum HookHealthCheck {
        ...
        for (_, eventValue) in hooks {
            ...
            for group in groups {
                ...
                for hook in hookEntries {
                    ...
                    // Only check Isle / Vibe Island commands
    ...
    /// Finds third-party (non-Isle) hook command names for display.
    ...
    /// Checks whether any Isle managed hooks exist in a config file.
