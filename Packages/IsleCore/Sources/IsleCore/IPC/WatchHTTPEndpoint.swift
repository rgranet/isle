...
public final class WatchHTTPEndpoint: @unchecked Sendable {
    private static let logger = Logger(subsystem: "com.withmii.isle", category: "WatchHTTPEndpoint")
    ...
    private let queue = DispatchQueue(label: "com.withmii.isle.watch.http", qos: .userInitiated)
