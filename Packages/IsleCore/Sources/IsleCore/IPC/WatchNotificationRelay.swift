...
public final class WatchNotificationRelay: @unchecked Sendable {
    private static let logger = Logger(subsystem: "com.withmii.isle", category: "WatchNotificationRelay")
    ...
    private let queue = DispatchQueue(label: "com.withmii.isle.watch.relay")
