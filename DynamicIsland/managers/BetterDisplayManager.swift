...
/// - Observe OSD notifications from BetterDisplay and route them to Isle's HUD pipeline
...
final class BetterDisplayManager: ObservableObject {
    ...
    /// Route a decoded BetterDisplay OSD notification to the active Isle HUD variant.
