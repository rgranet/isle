...
class MusicManager: ObservableObject {
    ...
    private func createController(for type: MediaControllerType) -> (any MediaControllerProtocol)? {
        ...
        case .podcasts:
            newController = PodcastsController()
        }
...
extension MusicManager {
    ...
    private static func brandAccentColor(forBundleIdentifier bundleIdentifier: String) -> Color? {
        ...
        case AmazonMusicController.bundleIdentifier:
            return amazonOrange
        case PodcastsController.bundleIdentifier:
            return podcastsPurple
        default:
            return nil
        }
    ...
    private static let podcastsPurple = Color(red: 0.553, green: 0.349, blue: 0.808)
}
