...
/// Bridges extension payload updates between Isle processes (main app, helpers, XPC services).
...
final class ExtensionEventBridge {
    ...
    private let ioQueue = DispatchQueue(label: "com.withmii.Isle.extensions.bridge", qos: .utility)
    ...
    private enum Channel: CustomStringConvertible {
        ...
        var notificationName: Notification.Name {
            switch self {
            case .liveActivities:
                return Notification.Name("com.withmii.Isle.extensions.liveActivitySnapshot")
            case .lockScreenWidgets:
                return Notification.Name("com.withmii.Isle.extensions.lockScreenWidgetSnapshot")
            case .notchExperiences:
                return Notification.Name("com.withmii.Isle.extensions.notchExperienceSnapshot")
            }
        }
