...
/// Shared constants for the Isle extension XPC service.
enum ExtensionXPCServiceConstants {
    static let machServiceName = "com.withmii.Isle.xpc"
}
...
final class ExtensionXPCServiceHost: NSObject, NSXPCListenerDelegate {
    ...
    func start() {
        ...
        Logger.log("Started Isle XPC listener", category: .extensions)
    }
    ...
    func stop() {
        ...
        Logger.log("Stopped Isle XPC listener", category: .extensions)
    }
