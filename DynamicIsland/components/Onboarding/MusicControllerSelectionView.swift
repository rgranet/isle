...
extension MediaControllerType {
    var description: String {
        ...
        case .podcasts:
            return String(localized: "Connects directly to the Apple Podcasts app. Useful when you mostly listen to podcasts rather than music. Skip controls advance to the next episode.")
        }
    }
}
